...
| T9.3b | Stage 9C Route B GGUF Q8/Q4 sweep | P1 | TODO (APPROVAL-GATED) | R-QUANT-01,R-MEAS-QUAL | **Requires explicit approval before any dependency/model download** (`download_approved=false`); `docs/QUANTIZATION_PREFLIGHT.md` Route B |
