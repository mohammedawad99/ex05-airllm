...
| T9.3 | Stage 9C quantization measured run (≥2 levels) | P0 | TODO (APPROVAL-GATED) | R-QUANT-01,R-MEAS-QUAL | **Route A** = fp32-vs-INT8, no download/dep (needs go-ahead). **Route B** = GGUF Q8/Q4, **requires explicit approval before any dependency/model download** (`download_approved=false`); see `docs/QUANTIZATION_PREFLIGHT.md` |
